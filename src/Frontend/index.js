...
var spotifySecret = 'c7dfaa9ed8bb4eed94c926a1ffdfd60c';
...
var song, songArtist, songCover, songLink, songLyrics, songInfo;
...
function checkIfUserInputText() {
    if (lyrics != undefined || lyrics != "" || lyrics != 'Enter a song/artist name!') {
        ...
        var itunes = document.createElement("img"); //convert to a better img
