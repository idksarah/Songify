...
searchSong("razzmatazz").then(result => {
    console.log(result);
});
...
let song, songArtist, songCover, songLink, songLyrics, songInfo;


let songContainer = document.createElement("div");
let streamingContainer = document.createElement("div");
let DOMsongCover = document.createElement("img");
let DOMsong = document.createElement("p");
let DOMsongArtist = document.createElement("p");
...
function checkIfUserInputText(){
    if(lyrics != undefined || lyrics != "" || lyrics != "Enter a song/artist name!"){
        searchSong(lyrics).then(result => { //god damn
            songInfo = result;
